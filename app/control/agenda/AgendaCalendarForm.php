...
class AgendaCalendarForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $id = new TEntry('id');
        $pessoa_id = new TDBUniqueSearch('pessoa_id', 'venda', 'Pessoa', 'id', 'nome','nome asc');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $action = new TAction(['AgendaCalendarFormView', 'onReload']);
    ...
    public function onDelete($param = null) 
    {
        if (isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                $action = new TAction(array('AgendaCalendarFormView', 'onReload'));
